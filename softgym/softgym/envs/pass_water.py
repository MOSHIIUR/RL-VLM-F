...
class PassWater1DEnv(FluidEnv):
    def __init__(self, observation_mode, action_mode, cached_states_path='pass_water_medium_1000_init_states.pkl', **kwargs):
        '''
    ...
    def render(self, mode='rgb_array', hide_picker=False):
        ...
        center_coordinates = (632, 394)  # Replace x and y with your coordinates
        radius = 20  # Replace r with your radius
    ...
    def initialize_camera(self):
        ...
        **Note: width and height is actually the screen width and screen height of FLex.
        ...
        '''
        self.camera_params = {
            'default_camera': {'pos': np.array([0.53, 2.0, 1.0]),
    ...
    def _get_obs(self):
        ...
        if self.observation_mode == 'cam_rgb':
            ...
            pos = np.zeros(shape=self.particle_obs_dim, dtype=float)
    ...
    def _get_info(self):
        ...
        return {
            ...
            "success": 1 if reward > -0.36 else 0,
        }
...
if __name__ == '__main__':
    np.random.seed(10)
    env = PassWater1DEnv(observation_mode='key_point',
                         action_mode='direct',
                         render=True,
                         headless=True,
                         horizon=50,
    ...
    # save_numpy_as_gif(np.array(images), 'pass_water.gif')
