...
## Five-goal observable MetaWorld runs
For the five goal-observable MetaWorld tasks, see `README.md`. It contains the minimal local setup for the full Qwen/vLLM preference-based runs and the `run_observable_qwen_full.sh` launcher for all five tasks.
